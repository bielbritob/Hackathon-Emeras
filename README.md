...
```
cd existing_repo
git remote add origin https://gitlab.com/hackathon-group6750332/hackathon-emeras.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/hackathon-group6750332/hackathon-emeras/-/settings/integrations)
